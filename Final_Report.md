...
model results in better predictions.
...
Of course, there are other models we have tried but are not listed here. We abandon those models because they obtained very bad outcomes in comparision with the ones mentioned above. 
